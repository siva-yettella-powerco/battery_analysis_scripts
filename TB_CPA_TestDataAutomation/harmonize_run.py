...
# extracted_files_paths = [i for i in extracted_files_paths if (i.parent.stem in ["DQ202510006223", "DQ202510006224", "DQ202510006225", "DQ202509003563", "DQ202509003564",
#                                                                                 "DQ202509003565", "DQ202509003560", "DQ202509003561", "DQ202509003562"]) & (i.suffix.lower() == '.xlsx')]
#extracted_files_paths = [i for i in extracted_files_paths if ("FCA08N00" in i.parent.stem) & (i.suffix.lower() == '.xlsx')]
